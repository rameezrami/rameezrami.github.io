...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to my personal space! :)\nMy name is Rameez, I'm a fullstack Software Engineer and a Javascript enthusiast.\nI love to talk about coding stuff and science.\nCurrently I'm working at Cubet Technolabs(infopark,kochi,kerala) as a Senior Software Engineer.\nI have 6.5+ years of experience in the software industry\n\nNow in order to get started, feel free to either execute the 'help' command or use the more user-friendly sidenav at your left.\nIn order to skip text rolling, double click/touch anywhere.",
        internet_explorer_warning: "NOTE: I see you're using internet explorer, this website won't work properly.",
        welcome_file_name: "home.txt",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about_me.txt": "My name is Rameez, I'm a fullstack Software Engineer and a Javascript enthusiast.\nI love to talk about coding stuff and science.\nCurrently I'm working at Cubet Technolabs(infopark,kochi,kerala) as a Senior Software Engineer.\nI have 6.5+ years of experience in the software industry\n",
        "intrests.txt": "Things that makes me myself...\n- Coding\n - Travelling\n - Badminton\n - Boxing\n - SkateBoarding\n - Sci-Fi",
        "qualifications.txt": "Academic Qualifications...\n- BSc Computer Science (2010-2013)\n- Senior School (2008-2010)\n- Secondary School (2008)",
        "experience.txt": "I have 6.5+ years of experience in the software industry...\n- Cubet Technolabs (5.5+ years)\n- 24NXT (1 Year)",
        "technical_expertise.txt": "Primary Technical Expertise...\n- JavaScript\n- Angular\n- Vue JS\n- Nuxt JS\n- Laravel\n- MySql\n- HTML5\n- SCSS\n- Node JS\nOther Technical Knowledge...\n- React JS\n- Angular-Redux Pattern (NGRX)\n- Angular - PWA\n- TypeScript\n- Vuex\n- Angular JS 1\n- jQuery\n- Electron\n- Socket.io, Websockets\n- ECMAScript\n- Express.js\n- Feathers.js\n- Python\n- AWS\n- Lambda\n- HTML\n- CSS\n- Flexbox\n- Php\n- Lumen\n- Joomla\n- Wordpress\n- PostgreSQL\n- MongoDB\n- ElasticSearch\n- Git\n- Heroku\n- NPM\n- Yarn\n- PIP\n- WebRTC\n- Kurento\n- Chrome extension development\n- LDAP\n- SAML\n- Webpack\n- GruntJS\n- GulpJS\n- SSH\n- poppler\n- EC2\n- AppSync",
        
        "contact.txt": "Contact Details\n- Email : rameespu@gmail.com\n- Phone: +919567044168\n - LinkedIn : https://www.linkedin.com/in/rameezrami\n - Github: https://github.com/rameezrami\n - Stackoverflow: https://stackoverflow.com/users/2251701/rameez-rami",
        "linkedin.txt": "https://www.linkedin.com/in/rameezrami",
        "github.txt": "https://github.com/rameezrami",
        "stackoverflow.txt": "https://stackoverflow.com/users/2251701/rameez-rami"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
...
var main = (function () {
    ...
    var cmds = {
        LS: { display:true, value: "ls", help: configs.getInstance().ls_help },
        CAT: { display:true,value: "cat", help: configs.getInstance().cat_help },
        WHOAMI: { display:true, value: "whoami", help: configs.getInstance().whoami_help },
        DATE: { display:true,value: "date", help: configs.getInstance().date_help },
        HELP: { display:true,value: "help", help: configs.getInstance().help_help },
        CLEAR: { display:true,value: "clear", help: configs.getInstance().clear_help },
        REBOOT: { display:true,value: "reboot", help: configs.getInstance().reboot_help },
